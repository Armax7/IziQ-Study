...
if(e.target.value) {
    ...
    let cambios2 = allUserDecks.filter(c => c.subcategory_id == e.target.value)
  ...
  textAlign="center"> 
      ...
      <Components.Dropdown options={[...categories]}  onChange={filterDecksByCategory} 
    ...
    <Components.Dropdown  options={[...subcategories]}  onChange={filterDecksBySubCategory}   
     color='#E96479'
     size = "lg" 
     width="10%" 
     bgColor="#4D455D" 
    ...
    bgColor="#F5E9CF"  justifyContent="center"> 
